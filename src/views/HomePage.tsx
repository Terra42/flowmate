...
const HomePage = () => {
  ...
  return (
    <div className="flex flex-col items-center py-8 px-4 text-center md:py-14 lg:py-0 lg:h-screen lg:justify-center">
      <Logo />
      ...
      <p className="mt-8 sm:w-3/4 md:text-lg lg:w-2/5 lg:text-xl lg:mt-16">
