...
const Offboarding = () => {
    ...
    return (
        ...
        <Button title="Ještě mám chuť pracovat" onClick={() => navigate("/create-session")}/>
        <p className="mt-8 mb-4">Líbí se ti moje aplikace a chceš mě podpořit?</p>
        <a href="https://buymeacoffee.com/petrazema" target="_blank" rel="noreferrer">
            <IconButton IconComponent={Rest} title="Kup mi kafe" isReversed={true}/>
        </a>    
        <p className="mt-8 mb-4">Máš pro mě zpětnou vazbu?</p>
        <a href="mailto:pzemanova.web@gmail.com" target="_blank" rel="noreferrer">
            <IconButton IconComponent={Message} title="Napiš mi" isReversed={true}/>
            </a>
        </div>
    );
}
